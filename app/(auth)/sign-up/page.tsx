...
import SignupComponent from '../sign-up/components/signupComponent';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">InklusionHub</h1>
            <p className="text-gray-600">Créer un compte</p>
            <h2 className="mt-4 text-2xl font-semibold text-gray-900">Rejoignez-nous</h2>
          </div>
