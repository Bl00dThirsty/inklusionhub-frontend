// app/formation/courses/[courseId]/modules/[moduleId]/lessons/[lessonId]/quiz/page.tsx
"use client";
...
const QuizDetailPage = () => {
  ...
  } = useGetQuizQuestionsQuery(quiz?.id ?? '', { 
    skip: !quiz?.id 
  });
  ...
  const handleEditQuestion = (questionId: string) => {
    router.push(
      `/formation/courses/${courseId}/modules/${moduleId}/lessons/${lessonId}/quiz/questions/${questionId}/edit`
    );
  };

  const handleAddQuestion = () => {
    router.push(
      `/formation/courses/${courseId}/modules/${moduleId}/lessons/${lessonId}/quiz/questions/create`
    );
  };

  const handleEditQuiz = () => {
    router.push(
      `/formation/courses/${courseId}/modules/${moduleId}/lessons/${lessonId}/quiz/edit/${quiz?.id}`
    );
  };
